...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: aaCjmpDK1mRWNV/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: ZoAxdtPgmi7IU9/render
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__mrrOu)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__viuvc)}
              />
            </React.Fragment>
          ),
          value: args.children
