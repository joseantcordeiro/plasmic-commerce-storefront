...
import Value from "../../Value"; // plasmic-import: KQA99gjpzsJSP/component
...
import sty from "./PlasmicEmojiValueProps.module.css"; // plasmic-import: eNqGZxXVZ_LgQf/css

import PlaneIcon from "./icons/PlasmicIcon__Plane"; // plasmic-import: x6NjYb4bpM_hkU/icon
...
import DocumentIcon from "./icons/PlasmicIcon__Document"; // plasmic-import: e07a9FqIlFWbl4/icon
import LockIcon from "./icons/PlasmicIcon__Lock"; // plasmic-import: HI8UbnspYUnZfG/icon
      ...
      {p.renderPlasmicSlot({
        defaultContents: (
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__aJr3D)}
          >
            <Value
              children2={
                <Button
                  className={classNames("__wab_instance", sty.button___2LtSl)}
                  colors={"black" as const}
                  endIcon={
                    <RightArrowIcon
                      className={classNames(projectcss.all, sty.svg__zaLiL)}
                      role={"img"}
                    />
                  }
                  rounded={true}
              ...
              className={classNames("__wab_instance", sty.value__qYlPn)}
              icon={
                <PlaneIcon
                  className={classNames(projectcss.all, sty.svg__rUxxT)}
                  role={"img"}
                />
              }
            >
            ...
            <Value
              children2={
                <Button
                  className={classNames("__wab_instance", sty.button__fmL5T)}
                  colors={"black" as const}
                  endIcon={
                    <RightArrowIcon
                      className={classNames(projectcss.all, sty.svg__yremb)}
                      role={"img"}
                    />
                  }
                  rounded={true}
              ...
              className={classNames("__wab_instance", sty.value__zRLn)}
              icon={
                <DocumentIcon
                  className={classNames(projectcss.all, sty.svg__xLvNi)}
                  role={"img"}
                />
              }
            >
            ...
            <Value
              children2={
                <Button
                  className={classNames("__wab_instance", sty.button__uxn13)}
                  colors={"black" as const}
                  endIcon={
                    <RightArrowIcon
                      className={classNames(projectcss.all, sty.svg___0AuFy)}
                      role={"img"}
                    />
                  }
                  rounded={true}
              ...
              className={classNames("__wab_instance", sty.value__upHop)}
              icon={
                <LockIcon
                  className={classNames(projectcss.all, sty.svg__nB1G9)}
                  role={"img"}
                />
              }
            >
